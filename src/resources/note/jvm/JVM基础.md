...
![img](.\Image\0082zybply1gc9lezaxrbj319v0u0k4w.jpg)
...
![jvm-stack-frame](.\Image\0082zybply1gc8tjehg8bj318m0lbtbu.jpg)
...
![img](.\Image\0082zybply1gc9s12g5wlj31li0owdm9.jpg)
...
![jvm-dynamic-linking](.\Image\0082zybply1gca4k4gndgj31d20o2td0.jpg)
...
<img src=".\Image\00831rSTly1gdbr7ek6pfj30ci0560t4.jpg" alt="JDK7" align="left" style="zoom:150%;" />
...
![img](.\Image\007S8ZIlly1gg06065oa9j31kw0u0q69.jpg)
...
#### 4.5.1 什么是 TLAB （Thread Local Allocation Buffer）?
...
存在堆内存中，类在加载、验证、准备完成后在堆中生成字符串对象实例，然后将该字符串对象实例的引用只存储到Sting Pool中，String Pool是一个StringTable类，是哈希表结果，里面存储的是字符串引用，具体的实例对象存储在堆中，这个stringtable表在每个hotspot中的实例只有一份，被所有类共享。
...
Java 基本类型的包装类的大部分都实现了常**量池技术**，即 Byte,Short,Integer,Long,Character,Boolean。
...
Boolean 直接返回True Or False。
 ...
 两种浮点数类型的包装类 Float,Double **没有**实现常量池技术。
...
![img](.\Image\db050d0052a44605a13043a0bec204f0.png)
...
![img](.\Image\007S8ZIlly1gg9i91ze2gj320i0riahe.jpg)
...
![img](.\Image\007S8ZIlly1gg04ve34c2j30z00u0dp7.jpg)
